...
def post_init_hook(cr, registry):
    # noqa TODO Remove after this is merged https://github.com/odoo/enterprise/pull/1617
    url = 'http://www.sat.gob.mx/sitio_internet/cfd/divisas/Divisas.xsd'
...
def _load_xsd_complement(cr, registry, url):
    ...
    if not xsd:
        return False
    complement = {
        'namespace': 'http://www.sat.gob.mx/divisas',
