...
class ResCompany(models.Model):
    ...
    def _load_xsd_attachments(self):
        ...
        url = 'http://www.sat.gob.mx/sitio_internet/cfd/TuristaPasajeroExtranjero/TuristaPasajeroExtranjero.xsd' # noqa
        namespace = 'http://www.sat.gob.mx/TuristaPasajeroExtranjero'
        xsd = self.env.ref(
            'l10n_mx_edi.xsd_cached_TuristaPasajeroExtranjero_xsd', False)
        if xsd:
            xsd.unlink()
