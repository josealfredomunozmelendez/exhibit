...
class LandingCost(InvoiceTransactionCase):
    def setUp(self):
        ...
        self.tax_purchase = self.env.ref('l10n_mx.1_tax14')
        self.product.write({
            'landed_cost_ok': True,
        ...
        self.product.categ_id.write({
            ...
            'property_stock_account_input_categ_id': self.env.ref(
                'l10n_mx.1_cuenta115_05'),
            'property_stock_account_output_categ_id': self.env.ref(
                'l10n_mx.1_cuenta115_05'),
            'property_stock_valuation_account_id': self.env.ref(
                'l10n_mx.1_cuenta115_01')
        })
