...
class TestL10nMxInvoiceCustoms(InvoiceTransactionCase):
    ...
    def test_01_l10n_mx_edi_invoice_custom(self):
        ...
        '''
        invoice_node = self.create_invoice()
        invoice_node.move_name = 'INV/2017/998'
        customs_number = '15  48  3009  0001234'
        invoice_node.invoice_line_ids.l10n_mx_edi_customs_number = \
            customs_number
        invoice_node.action_invoice_open()
        self.assertEqual(invoice_node.l10n_mx_edi_pac_status, "signed",
                         invoice_node.message_ids.mapped('body'))
        xml = invoice_node.l10n_mx_edi_get_xml_etree()
        ...
        '''
        invoice_node_2 = self.create_invoice()
        invoice_node_2.move_name = 'INV/2017/999'
        customs_number = '15  48  3009  0001234,15  48  3009  0001235'
        invoice_node_2.invoice_line_ids.l10n_mx_edi_customs_number = \
            customs_number
        invoice_node_2.action_invoice_open()
        self.assertEqual(invoice_node_2.l10n_mx_edi_pac_status, "signed",
                         invoice_node_2.message_ids.mapped('body'))
        xml = invoice_node_2.l10n_mx_edi_get_xml_etree()
        xml_expected = objectify.fromstring(node_expected)
