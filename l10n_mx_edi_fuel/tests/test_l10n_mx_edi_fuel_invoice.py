...
class TestL10nMxEdiInvoiceFuel(InvoiceTransactionCase):
    ...
    def setUp(self):
        ...
        self.fuel_product.l10n_mx_edi_code_sat_id = self.ref(
    ...
    def test_l10n_mx_edi_ecc_invoice(self):
        ...
        invoice.l10n_mx_edi_partner_bank_id = self.bank_account
        ...
        refund.l10n_mx_edi_partner_bank_id = self.bank_account
        ...
        self.xml_merge_dynamic_items(xml, xml_expected)
        # xml_expected.attrib['TipoDeComprobante'] = xml.attrib['TipoDeComprobante'] # noqa
        xml_expected.attrib['Folio'] = xml.attrib['Folio']
